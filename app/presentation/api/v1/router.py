...
# from .websocket import router as websocket_router  # Removido - incluído separadamente no main.py
...
# api_router.include_router(websocket_router, tags=["WebSocket"])  # Removido
